...
HD_PWD='D:/project/fpga/ai1/12.shift_register/12.shift_register.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_shift_register.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_shift_register.tcl -notrace
