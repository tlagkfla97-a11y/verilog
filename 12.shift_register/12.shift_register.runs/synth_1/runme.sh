...
HD_PWD='D:/project/fpga/ai1/12.shift_register/12.shift_register.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_shift_register.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_shift_register.tcl
