...
HD_PWD='D:/project/fpga/ai1/06.6bit/06.6bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder6.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder6.tcl -notrace
