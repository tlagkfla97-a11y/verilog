...
HD_PWD='D:/project/fpga/ai1/10.my_coffee_machine/10.my_coffee_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Coffee_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Coffee_top.tcl
