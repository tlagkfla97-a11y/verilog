...
HD_PWD='D:/project/fpga/ai1/10.my_coffee_machine/10.my_coffee_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Coffee_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Coffee_top.tcl -notrace
